...
export const updateConversation = async (req, res) => {
  ...
  try {
    ...
    const io =getIO();
    const populatedConversation = await Conversation.populate(updatedConversation, { path: 'role' });
    console.log("/**********    Conversacion actualizada    ************/ \n"+populatedConversation.role._id)
    io.emit("conversacion_actualizada", populatedConversation.role._id);
