...
import ChatViewersAlert from "./viewsWarning";

function Conversation() {

  //Variables globales para acceder a la informacion de forma dinamica
  const { chat, messages, redirectChat, sendMessageUser, deleteChat } = useChats(); //Chat con los mensajes
    ...
    {/* Se verifica que se haya seleccionado un chat */}
      {chat != null ? (
        <div className="col d-flex flex-column">
          ...
          {/* Lista de participantes en la conversacion */}
          {/*chat.participants.length > 0 && <ChatViewersAlert viewers={chat.participants} />*/}
